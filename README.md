...
python3 download_and_upload.py --workdir downloads --remote-dir /uploads

python3 download_and_upload.py --workdir downloads --remote-dir /uploads --targets rpmshare,earnvid --list links.txt